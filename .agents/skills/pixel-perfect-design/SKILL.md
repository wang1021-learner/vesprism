...
description: 像素级完美设计系统 — 为前端应用提供专业级站点设计。支持中英文双语，58 个顶级产品设计模板，9 部分完整设计规范，AI 可读 Markdown 格式，开箱即用无需 Figma。
version: 2.0.0
author: OpenClaw
license: MIT
metadata:
  hermes:
    tags: [design-system, chinese, templates, ui, css, pixel-perfect]
    related_skills: [frontend-design, ui-ux-pro-max]
---
