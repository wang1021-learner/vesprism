...
description: 来自 Vercel 工程团队的 React 和 Next.js 性能优化指南（中文）。64 条规则覆盖组件、数据获取、打包优化等 8 个类别。在编写、审查或重构 React/Next.js 代码时使用。
version: 1.0.0
author: Vercel
license: MIT
metadata:
  hermes:
    tags: [react, nextjs, performance, best-practices, chinese]
    related_skills: [frontend-design, tailwind-design-system]
---
