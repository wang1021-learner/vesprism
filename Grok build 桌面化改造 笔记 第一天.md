...
只加一个 `pub` 关键字。这是当日"最小侵入式"策略的体现。  
**【已更新 2026-07-29】** 现行规则：有更好方案时**可以改官方**，见 `docs/官方代码修改原则.md`。
...
- **改造原则（现行，2026-07-29）**：**好方案可以改官方代码**；默认仍优先复用官方能力与自建壳层。详见 `docs/官方代码修改原则.md`。  
  （本笔记写作时写的「只加不改」已废止，不再作为禁令。）
