...
1. If the question is about **current config** (what MCP servers, models, or settings are active),
   read `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/config.toml`. MCP servers are under `[mcp_servers.*]` sections.
...
2. If the question is about **how to do something** (setup, adding MCP servers, creating skills,
   ...
   `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/docs/user-guide/`. The available guides are:
   ...
   `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/README.md` for the comprehensive reference.

3. To **modify config** for the user, edit `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/config.toml` with search_replace.

4. To **create a skill** for the user, create `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/skills/<name>/SKILL.md`
   (read `D:/grokbuild/grok-build/crates/grok-gui-poc/test-grok-home/docs/user-guide/08-skills.md` for the SKILL.md format).