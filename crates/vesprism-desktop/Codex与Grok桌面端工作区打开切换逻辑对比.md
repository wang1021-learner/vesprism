...
> 文档目的：归纳 **OpenAI Codex 桌面端** 的工作区（Project / Thread / cwd）打开与切换逻辑，并与 **vesprism-desktop** 现状对照，便于后续对齐产品与实现。  
> 整理日期：2026-07-25  
...
| 维度 | Codex 桌面端 | Grok 桌面端（vesprism-desktop） |
|------|-------------|----------------------------------|
...
- Grok 实现：`crates/vesprism-desktop/`  
