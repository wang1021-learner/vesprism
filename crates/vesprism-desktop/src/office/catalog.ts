/**
 * 办公工作台模块配置与数据字典。
 * 覆盖场景胶囊、技能库、专家人设、企业知识库、自动化排程与连接器生态。
 */
...
export const OFFICE_NAV: readonly { id: OfficePanel; label: string; icon: string; badge?: string }[] = [
  ...
  { id: 'skills', label: '技能', icon: 'bolt', badge: '12' },
  { id: 'experts', label: '专家', icon: 'users', badge: '6' },
  { id: 'knowledge', label: '知识库', icon: 'book', badge: '8' },
...
export type OfficeFormat = 'doc' | 'xlsx' | 'pptx' | 'pdf' | 'web'
...
export const OFFICE_EXPERTS: readonly OfficeExpert[] = [
  {
    id: 'chief_secretary',
    name: '公文主笔 · 林秘书',
    role: '高级行政与公文专家',
...
export const OFFICE_SCHEDULES: readonly OfficeSchedule[] = [
  {
    ...
    name: '周一早报：华东业务对策一页纸',
    when: '每周一 09:00',
    action: '自动汇总周末材料，生成管理层周初简报并发送至飞书工作台',
    target: '飞书 / 华东管理层群',
    status: 'active',
    lastRun: '本周一 09:00 (成功交付)',
  },
  {
    id: 's2',
    name: '周五复盘：客户反馈与回款汇总',
...
export const OFFICE_CONNECTORS: readonly OfficeConnector[] = [
  {
    ...
    icon: '📁',
    status: 'connected',
    description: '已挂载本地工作材料夹与输出归档目录，支持细粒度沙箱隔离读写。',
    features: ['沙箱权限隔离', '多格式解析 (Docx/Xlsx/PDF)', '本地文件自动写盘'],
  },
  {
    id: 'feishu',
    name: '飞书 (Feishu / Lark)',
    ...
    icon: '🕊️',
    status: 'connected',
    description: '支持读取飞书云文档、多维表格数据，以及向群聊与工作台自动派发待办。',
    features: ['多维表格双向读写', '飞书文档导入导出', '群消息与待办卡片通知'],
  },
  {
    id: 'dingtalk',
    name: '钉钉 (DingTalk)',
    ...
    icon: '🎯',
    status: 'connected',
    description: '连接钉钉 OA 审批、文档库与日程待办体系，实现审批闭环与巡检通知。',
    features: ['OA 审批流触发', '钉钉文档同步', 'AI 助理群管与待办派发'],
  },
  {
    id: 'wecom',
    name: '企业微信 (WeCom)',
    ...
    icon: '💬',
    status: 'auth_needed',
    description: '连接企业微信客户群与内部通讯录，支持汇报简报自动触达。',
    features: ['应用消息推送', '微盘文档读取', '客户服务消息同步'],
  },
  {
    id: 'wps365',
    name: 'WPS 365 办公套件',
    ...
    icon: '📑',
    status: 'connected',
    description: '深度支持 WPS Word/Excel/PPT 格式引擎与在线协作文档无缝兼容。',
    features: ['原生 Word/PPT 渲染', 'Excel 复杂函数支持', '企业文档资产沉淀'],
  },
  {
    id: 'web_search',
    name: '行业情报与 Web 检索网关',
    ...
    icon: '🌐',
    status: 'connected',
    description: '提供合规的公开行业数据抓取、竞品快讯检索与权威政策法规模板。',
    features: ['实时资讯获取', '招投标公开信息检索', '政策法规数据库溯源'],
  },
]
